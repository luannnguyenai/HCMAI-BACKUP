...
| _SPEC-0006_ | Milvus schema and queries | _reserved_ | _unassigned_ | 01 SS 5.4 | Hybrid vector + structured filter; structured columns include organisers' `youtube_url`, `description`, OD tags. Optional 4th dense field `clip_organiser` for the provided baseline embedding (research-note 06 SS 2.4). Optional `qwen3vl` dense field for the offline visual-document lane ([ADR-0012](../adr/ADR-0012-qwen-offline-visual-document-lane.md)) |
